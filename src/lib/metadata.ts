...
export const metadataTemplates = {
  home: {
    ...
    keywords: ["robotics", "indonesia", "technology", "innovation", "ITS", "engineering"]
  },
  about: {
    title: "About Us",
    description: "Learn more about RIVAL ITS - our mission, vision, and the passionate team behind Indonesia's leading robotics innovation.",
