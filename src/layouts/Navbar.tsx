...
export default function Navbar() {
  ...
  return (
    <nav className="w-full px-8 py-6 bg-[#181a23]">
      <div className="max-w-[1400px] mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center gap-8">
          ...
          >
            ...
            {isAboutOpen && (
              <div className="absolute top-full left-0 w-48 bg-white rounded-lg shadow-lg border border-gray-200 py-2 z-50 mt-2">
        ...
        {/* Right: Language and Social Icons */}
