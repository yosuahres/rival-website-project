...
export default function EuropeanRoverChallengePage() {
    ...
    <div className="min-h-screen bg-[#1e5f4e]">
      ...
      <section className="relative h-[60vh] flex items-center justify-center">
        ...
        <div className="relative z-10 text-center text-white">
          <h1 className="text-6xl font-bold mb-6">European Rover Challenge</h1>
          <h1 className="text-6xl font-bold mb-6">(Remote) 2025</h1>
          <a
            href="https://roverchallenge.eu"
            target="_blank"
      ...
      <section className="w-full bg-[#1e5f4e] bg-opacity-70 py-8 flex items-center justify-center">
        <div className="max-w-7xl w-full min-h-[120px] mx-auto">
          ...
          The Australian Rover Challenge (ARCh) is an annual robotics competition held by the University of Adelaide, 
          where university students from across Australia and around the globe, battle it out in a full-scale Lunar mission, 
          using semi-autonomous rovers that they have designed and built themselves.
          Competitors showcase their skills in a custom built simulated lunar environment, and complete a range of tasks including 
          navigation, resource, and construction. Unlike many other rover competitions across the world which focus on Martian exploration, 
          the ARCh is focused specifically on completing tasks on a simulated Lunar surface.
          </p>
        </div>
      </section>
  ...
  <section className="relative w-full min-h-[300px] flex items-center justify-center py-14 overflow-hidden">
      ...
      <CompetitionTasksCarousel tasks={europeanRoverChallengeTasks} backgroundImage="/images/ROVER1.png" />
    </div>
  );
}
